...
def getResult():
    ...
    print(number, firstNumber, operation)
...
label1 = Label(frame1, text="123344", font=("helvetica", 48), background="red", foreground="#fff")
label1.grid(row=0, column=0, sticky="ewns")
...
clr = Button(frame2, text="C", font=("helvetica", 28), foreground="blue", command=lambda: handleOperationClick("clr"))
run = Button(frame2, text="=", font=("helvetica", 28), foreground="blue", command=lambda: getResult())
